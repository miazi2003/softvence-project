      ...
      <nav className="w-full bg-white">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-[154px] flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6 text-sm text-gray-700">
            <a href="#home" className="hover:text-black">Fix and Flip</a>
            <a href="#rental" className="hover:text-black">Rental Loans</a>
            <a href="#weLand" className="hover:text-black">Where We Lend</a>
            <a href="/aboutUs" className="hover:text-black">About Us</a>
            <a href="#resources" className="hover:text-black">Resources</a>
          </div>
          <div className="hidden md:block">
            <a href="/approve" className="bg-green-900 hover:bg-green-800 text-white text-sm font-semibold py-2 px-5 rounded-md shadow-md">
              GET APPROVED ONLINE
            </a>
          </div>
        </div>
